...
#
#'{Posterior probability: Mean of single population with normal endpoint}
#'
...
#' @export
#'
#' @examples Normal1SamplePP(n.t = 8, mu.t = 40, sd.t = 15, threshold = 35) if prior = "non-informative"
#' @examples Normal1SamplePP(n.t = 8, mu.t = 40, sd.t = 15, threshold = 35, prior = "informative", mu0t = 45, nu0t = 4, kappa0t = 7, var0t = 1) if prior = "informative"


Normal1SamplePP = function(n.t, mu.t, sd.t, hypothesis = "greater than", threshold,
