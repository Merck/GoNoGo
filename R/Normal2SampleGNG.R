...
#
#'{Difference/ratio of means of two independent populations with normal endpoint}
#'
...
#' @export
#'
#' @examples Normal2SampleGNG(n.t = 6, mu.t = 70, sd.t = 15, n.c = 2, mu.c = 40, sd.c = 15, measure = "difference", threshold = 30) if prior = "non-informative"
#' @examples Normal2SampleGNG(n.t = 6, mu.t = 70, sd.t = 15, n.c = 2, mu.c = 40, sd.c = 15, measure = "difference", threshold = 30, prior = "informative", mu0t = 70, nu0t = 8, kappa0t = 7, var0t = 1,  mu0c = 40, nu0c = 2, kappa0c = 2, var0c = 1) if prior = "informative"


Normal2SampleGNG = function(n.t, mu.t, sd.t, n.c, mu.c, sd.c, measure,
  ...
  if (!requireNamespace("metRology", quietly = TRUE)){
    ...
    for(i in 1:nsim){
      ...
      # Data generation
      data.t = rnorm(n.t, mu.t, sd.t)
      data.c = rnorm(n.c, mu.c, sd.c)
      # Sample mean
      sampmean.t = mean(data.t)
      sampmean.c = mean(data.c)
      # Sample variance
      sampvar.t = var(data.t)
      sampvar.c = var(data.c)
